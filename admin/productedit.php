         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input value="<?php echo $result_product['product_code'] ?>" name="product_code" type="text" placeholder="Nhập code sản phẩm..." class="medium" />
                    </td>
                </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                        <input value="<?php echo $result_product['productQuantity'] ?>" name="productQuantity" type="text" placeholder="Nhập số lượng sản phẩm..." class="medium" />
                    </td>
                </tr>
